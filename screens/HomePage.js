...
const courseData = {
  MainCourse: [
    ...
    { label: 'Peppermint Crips Tart - R650', value: 'Peppermint Crips Tart', fee: 650, description: 'A South African dessert made with layers of whipped cream, caramel, and crushed peppermint crisp bars.' },
    { label: 'Potjiekos - R450', value: 'Potjiekos', fee: 450, description: 'A slow-cooked stew typically prepared outdoors in a round, cast-iron pot, filled with meats and vegetables.' },
  ...
  Starter: [
    { label: 'Cape Malay Curry - R400', value: 'Cape Malay Curry', fee: 400, description: 'A flavorful curry made with aromatic spices like cumin, coriander, turmeric, and typically includes lamb or chicken.' },
    ...
    { label: 'Bunny Chow - R200', value: 'Bunny Chow', fee: 200, description: 'A hollowed-out loaf of bread filled with spicy curry, originating from Durban, South Africa.' },
